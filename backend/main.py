...
class AnonymizeRequest(BaseModel):
    ...
    entity_types: List[str] = Field(default_factory=lambda: ["PERSON", "EMAIL", "PHONE", "ADDRESS", "ORG", "DATE", "URL", "API_KEY", "CREDIT_CARD", "GOVERNMENT_ID", "BANK_ACCOUNT", "PRIVATE_KEY", "COMPANY_REGISTRATION_NUMBER", "BOOKING_REFERENCE", "TICKET_REFERENCE", "ORDER_ID", "TRANSACTION_ID", "IP_ADDRESS", "USERNAME", "COORDINATE", "FILE_PATH"])
