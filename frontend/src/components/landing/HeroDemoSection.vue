...
const useCaseExamples: Record<string, string[]> = {
  Developers: [
    ...
    [
      ...
      'User: Can you check the outage report before I send it?',
      'Assistant: Sure, paste it here.',
      'User: On-call was Jamie Cole, email jamie.cole@infraops.dev, phone +44 7700 967431.',
      'User: Host 10.44.12.7 failed after deploy using token ghp_X8t2Lm1Qp3v7Kz9Ab5cD6nR4yH0m',
    ].join('\n'),
  ],
  Recruiters: [
    [
