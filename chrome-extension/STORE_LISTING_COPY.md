...
Key features:
- One-click sanitisation in supported AI chat pages.
- Optional Automatic mode that sanitises before send.
- Context menu action for highlighted text.
- Compact entity details view for quick review.
- Privacy-first positioning with no prompt content storage.
